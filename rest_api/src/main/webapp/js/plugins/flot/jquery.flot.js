    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        var series = [],
            options = {
                ...
                colors:["#3F97FE", "#FF9806", "#A62D2D", "#25678B", "#4F9B2B"],
                legend:{
                    show:true,
                ...
                grid:{
                    show:true,
                    aboveData:false,
                    color:"rgba(255,255,255,0.2)", // primary color used for outline and labels
        ...
        function insertLegend() {
            ...
            var table = '<table style="font-size:smaller;color: #FFF;">' + fragments.join("") + '</table>';
